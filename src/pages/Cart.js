...
const Cart = () => {
  const productData = useSelector((state) => state.athena.productData);
  const userInfo = useSelector((state) => state.athena.userInfo);
    ...
    <div>
      ...
      {productData.length > 0 ? (
        ...
        <div className="max-w-screen-xl mx-auto py-10 flex flex-col items-center gap-2 justify-center">
          <p className="text-xl text-pink-600 font-titleFont font-semibold">
